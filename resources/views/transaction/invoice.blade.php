...
<body>
    <div class="card">
        <div class="card-body mx-4">
            <div class="container">
            <p class="my-5 mb-0 text-center" style="font-size: 30px;">Belva Food Area</p>
            <p class="mt-0 mb-1 text-center" style="font-size: 15px;">Jl Semarang-Bekasi No 15, DKI Jakarta</p>
            <p class="mt-0 mb-4 text-center" style="font-size: 15px;">0891-2345-6789</p>
            @foreach ($data as $key)
                @php
            ...
            <div class="text-center" style="margin-top: 90px;">
                <p class="mb-0 d-flex align-items-center justify-content-center"><u class="text-info text-decoration-none"><img src="/images/logofood.png" alt="" srcset="" width="20">Belva Food Area</u></p>
                <p>Thanks for joining us at Belva Food Area. </p>
            </div>
