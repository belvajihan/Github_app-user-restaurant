...
<div class="container">
        <div class="row my-5 d-flex flex-column justify-content-between">
            <div class="col d-flex flex-column align-items-center">
                ...
                <h2>Belva Food Area</h2>
                <p class="mb-1">Jl Bekasi-Semarang No 15, DKI Jakarta</p> 
                <p class="mb-1">20891-2345-6789</p>
            </div>
        ...
        <table class="table my-5">
            <thead>
            <tr>
                <th scope="col">Transaction date u go</th>
                <th scope="col">Product u order</th>
                <th scope="col">No Table u choose</th>
                <th scope="col">Total ur payment</th>
                @can('manager')
