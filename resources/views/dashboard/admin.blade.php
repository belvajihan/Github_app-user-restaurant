    ...
    <div class="card">
        <div class="d-flex align-items-end row">
            <div class="col-sm-7 ps-3">
                <div class="card-body">
                    <h5 class="card-title text-primary">Wellcome Back {{ auth()->user()->name }}! 🎉 enjoy your day!!</h5>
                    <p class="mb-4 text-dark">
                        You have done <span class="fw-bold">72%</span> more sales today. Check your new badge in
                        your profile. GREATT JOB {{ auth()->user()->name }}!
                    </p>
        ...
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">This is our great Admin</span>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> {{ $admin[0]->admin }} main day user</small>
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> {{ $manager[0]->manager }} main day user</small>
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> {{ $cashier[0]->cashier }} main day user</small>
                </div>
            </div>
        </div>
        <div class="col-lg-5 col-md-12 col-6 mb-4 shadow rounded">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="fw-semibold d-block mb-1 text-dark">Total user for today</span>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> {{ $total_user[0]->total_user }} main day user</small>
                </div>
            </div>
        </div>
    </div>
