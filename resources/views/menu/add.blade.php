...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/menu" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="name-product" class="form-label">Name for main product</label>
            ...
            <div class="mb-3">
                <label for="price" class="form-label">Price is worth!</label>
            ...
            <div class="mb-4">
                <label for="category" class="form-label">Category our menu</label>
                <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                    <option selected disabled hidden>- select category -</option>
                    <option value="food"  @if (old('category') == "food") {{ 'selected' }} @endif >Delicious Food</option>
                    <option value="drink"  @if (old('category') == "drink") {{ 'selected' }} @endif >Fresh treasure our drink</option>
                    <option value="dessert"  @if (old('category') == "dessert") {{ 'selected' }} @endif >Sweetest our dessert</option>
                </select>
                @error('category')
                    <div class="invalid-feedback">
                        {{ $message }}
