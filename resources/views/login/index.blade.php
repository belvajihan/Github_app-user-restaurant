	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<h2 class="auth-heading text-center mb-5">Login to Belva Food Area</h2>
			        ...
			        <div class="auth-form-container text-start">
						<form class="auth-form login-form" action="/login" method="POST">
							...
							<div class="email mb-3">
								<label class="sr-only" for="signin-username">Drop ur Username</label>
							...
							<div class="text-center">
								<button type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto">Log In Here!</button>
							</div>
						</form>
					</div>
			    </div>
		    ...
		    <div class="auth-background-overlay p-3 p-lg-5">
			    <div class="d-flex flex-column align-content-end h-100">
				    ...
				    <div class="overlay-content p-3 p-lg-4 rounded">
					    <h5 class="mb-3 overlay-title">Motivation for all day</h5>
					    <div>Our task is not only to serve delicious food but also to provide friendly and efficient service. Focus on good service quality and success will follow. SO CHOOSE US FOR BETTER QUALITY LIFE!</div>
				    </div>
				</div>
		    </div>
	    </div>
