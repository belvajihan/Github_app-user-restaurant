    ...
    <form action="/user/edit/{{ $key->id }}" method="POST" class="app-card app-card-account shadow-sm d-flex flex-column align-items-start" enctype="multipart/form-data">
        ...
        <div class="app-card-body px-4 w-100">
            ...
            <div class="item border-bottom mt-4 mb-4">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 mb-0">
                        <div class="item-label"><strong>What's ur Name?</strong></div>
            ...
            <div class="item border-bottom mt-4 mb-4">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 mb-0">
                        <div class="item-label"><strong>What's ur email?</strong></div>
            ...
            <div class="item border-bottom mt-4 mb-4">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 mb-0">
                        <div class="item-label"><strong>Tell ur Username</strong></div>
            ...
            <div class="item border-bottom mt-4 mb-4">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 mb-0">
                        <div class="item-label"><strong>What's ur Role?</strong></div>
        ...
        <div class="app-card-footer p-4 mt-auto">
            <button type="submit" class="btn btn-success text-white">Save all Change!</button>
